...
<body>
    <div class="container mt-4">
        ...
        <form action="index.cfm?action=email.send" method="post" class="mt-4">
            <div class="mb-3">
            ...
            <a href="index.cfm?action=email.templates" class="btn btn-secondary">Manage Templates</a>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#templateID').change(function() {
                ...
                if (templateID) {
                    $.get('index.cfm?action=email.getTemplate&templateID=' + templateID, function(data) {
